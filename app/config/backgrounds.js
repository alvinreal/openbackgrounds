export const backgrounds = [
  ...
  },
  {
    ...
    name: 'Particle Waves',
    description: 'Animated 3D particle field with wave motion rendered in WebGL.',
    category: 'WebGL',
    author: {
      name: 'Boris Šehovac',
  ...
  },
  {
    ...
    name: 'Cosmic Anomaly',
    description: 'Swirling cosmic bloom of particles with interactive parallax depth.',
    category: 'WebGL',
    author: {
      name: 'Techartist',
  ...
  },
  {
    ...
    name: 'Sombrero Dunes',
    description: 'Lavender wireframe dunes pulsing with layered perlin sombrero waves.',
    category: 'WebGL',
    author: {
    }
  },
  ...
  },
  {
    ...
    name: 'Ribbon Flow',
    description: 'Flowing ribbon with organic wave motion and noise deformation in WebGL.',
    category: 'WebGL',
    author: {
      name: 'Boris Šehovac',
      url: 'https://codepen.io/bsehovac'
  ...
  },
  {
    ...
    description: 'Soft-focus spectral bands with cascading color gradients rendered on canvas.',
    category: 'Canvas',
    author: {
    }
  },
  {
    ...
    description: 'Layered spectral flows that drift like nebular currents across a deep sky.',
    category: 'WebGL',
    author: {
  ...
  },
  {
    ...
    name: 'Fluid Ripples',
    description: 'Interactive fluid simulation with swirling ripples and vorticity dynamics.',
    category: 'WebGL',
    author: {
      name: 'Filip Zrnzevic',
  ...
  },
  {
    ...
    name: 'Metaball Orbit',
    description: 'Organic metaballs with ray marching, smooth blending, and mouse interaction.',
    category: 'WebGL',
    author: {
      name: 'Filip Zrnzevic',
      url: 'https://codepen.io/filipz'
